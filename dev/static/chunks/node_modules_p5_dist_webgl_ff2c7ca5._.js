 ...
 */ class Geometry {
   ...
   */ saveObj(fileName = 'model.obj') {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$io$2f$utilities$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["downloadFile"])(blob, fileName, 'obj');
    }
    /**
   ...
   */ saveStl(fileName = 'model.stl', { binary = false } = {}) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$io$2f$utilities$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["downloadFile"])(blob, fileName, 'stl');
    }
    /**
   ...
   * </code>
   * </div>
   */ computeNormals(shadingType = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["F"], { roundToPrecision = 3 } = {}) {
        const vertexNormals = this.vertexNormals;
        let vertices = this.vertices;
        const faces = this.faces;
        let iv;
        if (shadingType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["y"]) {
            const vertexIndices = {};
 ...
 */ class GeometryBuilder {
   ...
   */ addImmediate(geometry, shapeMode, { validateFaces = false } = {}) {
        const faces = [];
        if (this.renderer.states.fillColor) {
            if (shapeMode === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["r"] || shapeMode === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["s"]) {
            ...
            } else if (shapeMode === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["q"]) {
                for(let i = 2; i < geometry.vertices.length; i++){
                    faces.push([
                        0,
                        i - 1,
            ...
            } else if (shapeMode === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["p"]) {
...
class ShapeBuilder {
    constructor(renderer){
        this.renderer = renderer;
        this.shapeMode = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["m"];
        this.geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"](undefined, undefined, undefined, this.renderer);
    ...
    constructFromContours(shape, contours) {
        ...
        for (const contour of contours){
            ...
            for (const vertex of contour){
                ...
                // are rendered.)
                if (this.shapeMode === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Q"]) {
        ...
        if (this.shapeMode === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["m"]) {
            this.isProcessingVertices = true;
            this._tesselateShape();
            this.isProcessingVertices = false;
        } else if (this.shapeMode === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["s"]) {
            ...
            this.shapeMode = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["r"];
        } else if (this.shapeMode === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Q"]) {
            ...
            this.shapeMode = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["p"];
        }
        if (this.renderer.states.textureMode === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a1"] && this.renderer.states._tex !== null && this.renderer.states._tex.width > 0 && this.renderer.states._tex.height > 0) {
   ...
   */ _calculateEdges(shapeMode, verts) {
        ...
        let contourStart = -1;
        switch(shapeMode){
            case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["r"]:
                ...
                break;
            case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["q"]:
                ...
                break;
            case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["p"]:
                ...
                break;
            case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["L"]:
            ...
            case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Q"]:
                ...
                break;
            case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["s"]:
                // 0---2---4
                // |   |   |
                // 1---3---5
 ...
 */ function interaction(p51, fn) {
   ...
   */ fn.debugMode = function(...args) {
        ...
        if (args[0] === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["G"]) {
            p51.lifecycleHooks.postdraw.push(this._grid(args[1], args[2], args[3], args[4], args[5]));
        } else if (args[0] === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$Bt1VTUeD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["A"]) {
...
function loading(p51, fn) {
   ...
   */ fn.loadModel = async function(path, fileType, normalize, successCallback, failureCallback) {
        ...
        try {
            if (fileType.match(/\.stl$/i)) {
                const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$rendering$2d$COLWmJqb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])(path, 'arrayBuffer');
                parseSTL(model, data);
                if (normalize) {
                    model.normalize();
                }
                ...
                const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$rendering$2d$COLWmJqb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])(path, 'text');
   ...
   */ async function parseMtl(mtlPath) {
        ...
        let materials = {};
        const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$rendering$2d$COLWmJqb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])(mtlPath, 'text');
        const lines = data.split('\n');
...
;
function text(p5, fn) {
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$rendering$2d$COLWmJqb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.maxCachedGlyphs = function() {
  ...
  */ // rendering constants
   ...
   */ class FontInfo {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$rendering$2d$COLWmJqb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._renderText = function(line, x, y, maxY, minY) {
...
;
function webgl(p5) {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$rendering$2d$COLWmJqb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["r"])(p5, p5.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$rendering$2d$COLWmJqb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["p"])(p5, p5.prototype);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$rendering$2d$COLWmJqb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["l"])(p5, p5.prototype);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$rendering$2d$COLWmJqb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["m"])(p5, p5.prototype);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$rendering$2d$COLWmJqb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(p5, p5.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$rendering$2d$COLWmJqb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["f"])(p5, p5.prototype);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$rendering$2d$COLWmJqb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["s"])(p5, p5.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$rendering$2d$COLWmJqb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(p5, p5.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$strands$2f$p5$2e$strands$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(p5, p5.prototype);
}
;
}),
]);

//# sourceMappingURL=node_modules_p5_dist_webgl_ff2c7ca5._.js.map